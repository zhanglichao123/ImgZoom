...
public class RecycleViewPartingLineDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycleViewPartingLineDivider(Context context, int orientation) {
     ...
     */
    public RecycleViewPartingLineDivider(Context context, int orientation, int drawableId) {
     ...
     */
    public RecycleViewPartingLineDivider(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
